 ...
 *         custom function for getting the index of target string in source string
 *         source: the source string
 *         target: the target string
 *         return: the index of target string in source string, -1 denotes not found
 *
 * int indexOf ( const char * source, char * target, int startIndex)
 *         custom function for getting the index of target string in source string
 *         after a specific start index
 *         source: the source string
 *         target: the target string
 *         startIndex: the start index to search from
 *         return: the index of target string in source string after the specified
 *                 start index, -1 denotes not found
 *
 * int lastIndexOf ( const char * source, char * target)
 *         custom function for getting the last index of target string in source string
 *         source: the source string
 *         target: the target string
 *         return: the last index of target string in source string, -1 denotes not found
 *
 * References:
